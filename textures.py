...
class Textures:
    ...
    def __init__(self, image_side_length):
        ...
        self.revealed_bomb  = self.GetTkPhotoImage("./Resources/revealed_mine.png"  , image_side_length, image_side_length)
        self.flagged_bomb   = self.GetTkPhotoImage("./Resources/flagged_mine.png"   , image_side_length, image_side_length)
